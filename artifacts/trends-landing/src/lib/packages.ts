    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          "🎯 Премиум-таргет + AI-оптимизация креативов — персональный менеджер кампаний 24/7",
          "📊 Ежемесячный отчёт по рекламной эффективности — детальная аналитика ROI и ROAS",
        ],
      },
      {
        id: "miniapp",
      ...
      },
      {
        ...
        items: [
          ...
          "✈️ VIP-приглашения на все офлайн-мероприятия Trends — конференции и встречи инвесторов",
        ],
      },
      {
        id: "influence",
        ...
        items: [
          ...
          "🎤 Co-founder branding — упоминание как стратегического партнёра во всех PR-материалах",
          "🌐 Публичное упоминание в пресс-релизах, подкастах и интервью команды",
        ],
      },
      {
        id: "future",
        ...
        items: [
          ...
          "🛡 Tag-along rights и drag-along protection при M&A",
          "💹 Персональный инвест-менеджер — сопровождение по всем финансовым и юридическим вопросам",
        ],
      },
    ],
  },
