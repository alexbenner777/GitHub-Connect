...
function AdvantagesGrid({ openInvest: _openInvest }: { openInvest: (pkg?: string) => void }) {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5">
      {/* Item 1 — full width */}
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0 }} variants={slideUp}
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground [overflow-x:clip]">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0 }} variants={fadeRight}
              ...
              <div className="relative inline-flex justify-center items-center" style={{ height: 'clamp(480px, 85vw, 580px)' }}>
                ...
                <div className="absolute z-0 overflow-hidden rounded-[9%]"
                  style={{ top: '4%', bottom: '7%', left: '8%', right: '8%' }}>
                  <video
                ...
                <img src={iphonePath} alt="Trends App"
                  ...
                  style={{ mixBlendMode: 'multiply', transform: 'scaleY(1.08)', transformOrigin: 'top center' }} />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id="problem" className="py-14 md:py-24 relative scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0 }} variants={staggerFast}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
            {PACKAGES_DATA.map((pkg, i) => (
              <motion.div key={pkg.id} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0 }} variants={fadeIn}
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-4 items-stretch">
              {[
                ...
                <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0 }}
